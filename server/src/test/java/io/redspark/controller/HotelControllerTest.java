...
public class HotelControllerTest extends ApplicationTest {
	...
	public void testeListWithPagination() {
		...
		Page<HotelDTO> page = get("/hotel").queryParam("page", "0").queryParam("size", "2").status(HttpStatus.OK)
	...
	public void testCreate() {
		...
		ResponseEntity<HotelDTO> response = post("/hotel").formParam("name", c.getName())
		    .formParam("address", c.getAddress()).formParam("zip", c.getZip()).formParam("city.id", cidade.getId())
		    .formParam("city.name", cidade.getName()).formParam("city.state", cidade.getState())
		    .formParam("city.country", cidade.getCountry()).status(HttpStatus.CREATED).getResponse(HotelDTO.class);
	...
	public void testCreateNotPersistyCity() {
		...
		ResponseEntity<HotelDTO> response = post("/hotel").formParam("name", c.getName())
		    .formParam("address", c.getAddress()).formParam("zip", c.getZip()).formParam("city.id", cidade.getId())
		    .formParam("city.name", "newname").formParam("city.state", cidade.getState())
		    .formParam("city.country", cidade.getCountry()).status(HttpStatus.CREATED).getResponse(HotelDTO.class);
	...
	public void testCreateInvalidCity() {
		...
		post("/hotel").formParam("name", c.getName()).formParam("address", c.getAddress()).formParam("zip", c.getZip())
		    .formParam("city.id", 9999).formParam("city.name", "newname").formParam("city.state", cidade.getState())
		    .formParam("city.country", cidade.getCountry()).status(HttpStatus.NOT_FOUND).getResponse();
	...
	public void testUpdate() {
		...
		ResponseEntity<HotelDTO> response = put("/hotel/%s", c.getId()).formParam("name", name)
		    .formParam("address", c.getAddress()).formParam("zip", c.getZip()).formParam("city.id", cidade.getId())
		    .formParam("city.name", "teste").formParam("city.state", cidade.getState())
		    .formParam("city.country", cidade.getCountry()).status(HttpStatus.OK).getResponse(HotelDTO.class);
	...
	public void testUpdateWithInvalidCity() {
		...
		put("/hotel/%s", c.getId()).formParam("name", name).formParam("address", c.getAddress())
		    .formParam("zip", c.getZip()).formParam("city.id", 9999).formParam("city.name", "teste")
		    .formParam("city.state", cidade.getState()).formParam("city.country", cidade.getCountry())
		    .status(HttpStatus.NOT_FOUND).getResponse();
	...
	public void testDelete() {
		...
		ResponseEntity<HotelDTO> response = delete("/hotel/%s", c1.getId()).status(HttpStatus.OK).getResponse(
		    HotelDTO.class);
	...
	public void testUpdateNotFound() {
		...
		saveall(bruno);
		signIn(bruno);
		put("/hotel/1").formParam("name", "name").status(HttpStatus.NOT_FOUND);
	}
	...
	public void testeCreateInvalidParam() {
		...
		post("/hotel").status(HttpStatus.BAD_REQUEST).getResponse();
	}
}
