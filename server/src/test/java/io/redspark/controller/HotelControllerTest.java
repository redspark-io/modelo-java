...
public class HotelControllerTest extends ApplicationTest {
  ...
  public void testeListWithPagination() {
    ...
    page = get("/hotel").queryParam("size", "2").queryParam("page", "2").expectedStatus(HttpStatus.OK)
        .getPage(HotelDTO.class);
  ...
  public void testSearchByName() {
    ...
    Page<HotelDTO> page = get("/hotel").queryParam("search", "inn").expectedStatus(HttpStatus.OK)
        .getPage(HotelDTO.class);
  ...
  public void testSearchByAddress() {
    ...
    Page<HotelDTO> page = get("/hotel").queryParam("search", "orange").expectedStatus(HttpStatus.OK)
        .getPage(HotelDTO.class);
  ...
  public void testSearchByZip() {
    ...
    Page<HotelDTO> page = get("/hotel").queryParam("search", "07105").expectedStatus(HttpStatus.OK)
        .getPage(HotelDTO.class);
  ...
  public void testSearchByCityName() {
    ...
    Page<HotelDTO> page = get("/hotel").queryParam("search", "paulo").expectedStatus(HttpStatus.OK)
        .getPage(HotelDTO.class);
  ...
  public void testRead() {
    ...
    ResponseEntity<HotelDTO> response = get("/hotel/" + c1.getId()).expectedStatus(HttpStatus.OK)
