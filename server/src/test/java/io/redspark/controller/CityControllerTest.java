...
public class CityControllerTest extends ApplicationTest {
	...
	public void testeListWithPagination() {
		...
		page = get("/city").queryParam("size", "2").queryParam("page", "2").expectedStatus(HttpStatus.OK).getPage(CityDTO.class);
	...
	public void testDelete() {
		...
		ResponseEntity<CityDTO> response = delete("/city/%s", c1.getId()).expectedStatus(HttpStatus.OK).getResponse(CityDTO.class);
