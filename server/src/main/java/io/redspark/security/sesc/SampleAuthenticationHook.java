...
/**
 * Essa classe server para adicionar ao usuário autenticado mais informações,
...
public class SampleAuthenticationHook implements AuthenticationHook<CustomSescUser> {
	...
	/**
	 * Exemplo de Hook, ele procura na base local o usuário e se encontra ele cria
	 * ele com as Roles esperadas.
	 */
	@Override
