...
public class CityControllerTest extends SescApplicationTest {
  ...
  public void testeListWithPagination() {
    ...
    page = get("/city").queryParam("size", "2").queryParam("page", "2").expectedStatus(HttpStatus.OK)
        .getPage(CityDTO.class);
  ...
  public void testSearchByName() {
    ...
    Page<CityDTO> page = get("/city").queryParam("search", "paulo").expectedStatus(HttpStatus.OK)
        .getPage(CityDTO.class);
  ...
  public void testRead() {
    ...
    ResponseEntity<CityDTO> response = get("/city/%s", c1.getId()).expectedStatus(HttpStatus.OK)
  ...
  public void testDelete() {
    ...
    ResponseEntity<CityDTO> response = delete("/city/%s", c1.getId()).expectedStatus(HttpStatus.OK)
        .getResponse(CityDTO.class);
  ...
  public void testDeleteWithHotel() {
    ...
    delete("/city/%s", c1.getId()).expectedStatus(HttpStatus.PRECONDITION_FAILED).getResponse();
  }
